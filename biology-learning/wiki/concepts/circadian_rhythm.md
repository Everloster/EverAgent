---
id: concept-circadian_rhythm
title: "昼夜节律（Circadian Rhythm）"
type: concept
...
## L1 是什么
约 24 小时周期的内源性生理节律，由下丘脑视交叉上核（SCN）主导，通过外周钟基因网络同步全身组织。来源：P26_walker_why_we_sleep_2017 睡眠分期节、晚型人作息与力量训练_深度研究报告 §理解这个作息的生物学基础
...
## L5 前沿与争议
- 2017 年诺贝尔生理学/医学奖授予 Hall、Rosbash、Young，表彰昼夜节律分子机制的发现
- Time-Restricted Eating (TRE) 等进食时间干预的长期效果仍需 RCT 确认
- 基因治疗修改 PER3 对时型的影响在动物模型中已有初步数据，人类应用远未成熟
