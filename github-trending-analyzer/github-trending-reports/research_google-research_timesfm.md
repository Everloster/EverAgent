# google-research/timesfm 深度研究报告
...
*   [Google Sheets](https://workspaceupdates.googleblog.com/2026/02/forecast-data-in-connected-sheet
...
| 指标 | 数值 | 数据源 |
|------|------|--------|
| Stars | 24,791 | GitHub API |
| Forks | 2,353 | GitHub API |
| 开放 Issue/PR | 225 | GitHub API |
