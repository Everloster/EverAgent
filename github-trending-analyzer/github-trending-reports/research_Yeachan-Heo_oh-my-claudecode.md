...
oh-my-claudecode（简称 OMC）是一个面向 Claude Code 的多智能体团队协作框架。与传统的单用户 Claude Code 不同，OMC 解决了"多人协作"的问题——多个子任务并行执行、团队角色分工、代码审查和规划。项目自称"�的最新版），自称是"史上最强 copilot"，支持并行执行、多角色分工。2026 年 1 月上线，v4.9.1，12,359 Stars，是 Claude Code 生态中增长最快的团队协作工具。
