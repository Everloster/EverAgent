# addyosmani/agent-skills 深度研究报告
...
| 默认分支 | main |
| 开放 Issue/PR 数 | 138 |
| 话题标签 | agent-skills, antigravity, antigravity-ide, claude-code, cursor, skills |
...
| 指标 | 数值 | 数据源 |
|------|------|--------|
| Stars | 64,605 | GitHub API |
| Forks | 6,978 | GitHub API |
| 开放 Issue/PR | 138 | GitHub API |
