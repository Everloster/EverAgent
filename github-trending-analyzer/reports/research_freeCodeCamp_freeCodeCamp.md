# freeCodeCamp/freeCodeCamp 深度研究报告
...
- [Reporting Security Issues and Responsible Disclosur
...
| 默认分支 | main |
| 开放 Issue/PR 数 | 175 |
| 话题标签 | careers, certification, community, curriculum, d3, education, freecodecamp, javascript, learn-to-code, math, nodejs, nonprofits, programming, react, teachers |
...
| 指标 | 数值 | 数据源 |
|------|------|--------|
| Stars | 450,045 | GitHub API |
| Forks | 45,183 | GitHub API |
| 开放 Issue/PR | 175 | GitHub API |
