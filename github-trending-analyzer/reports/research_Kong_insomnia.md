...
|------|------|
| 全称 | Kong/insomnia |
| GitHub URL | https://github.com/Kong/insomnia |
| GitHub Stars | 39,483 |
| GitHub Forks | 2,335 |
| 主语言 | TypeScript |
| 许可证 | Apache-2.0 |
...
| 默认分支 | develop |
| 开放 Issue/PR 数 | 855 |
| 话题标签 | api, api-client, api-design, curl, electron-app, graphql, grpc, http-client, rest-api, websockets |
...
| 指标 | 数值 | 数据源 |
|------|------|--------|
| Stars | 39,483 | GitHub API |
| Forks | 2,335 | GitHub API |
| 开放 Issue/PR | 855 | GitHub API |
