...
- **64 vulnerability patterns** across 16 categories: prompt injection, data exfiltration, privilege escalat
...
| 指标 | 数值 | 数据源 |
|------|------|--------|
| Stars | 8,928 | GitHub API |
| Forks | 696 | GitHub API |
| 开放 Issue/PR | 98 | GitHub API |
