...
| # | 论文 | 年份 | 领域 | 优先级 | 分析报告 |
|---|------|------|------|--------|---------|
| 01 | Computing Machinery and Intelligence (Turing) | 1950 | 计算理论 | ⭐⭐⭐ | ⬜ 待读 |
| 02 | A Mathematical Theory of Communication (Shannon) | 1948 | 信息论 | ⭐⭐⭐ | ⬜ 待读 |
...
| 05 | Time, Clocks, and the Ordering of Events (Lamport) | 1978 | 分布式 | ⭐⭐⭐ | ⬜ 待读 |
...
| 09 | The Google File System (Ghemawat et al.) | 2003 | 分布式存储 | ⭐⭐⭐ | ⬜ 待读 |
| 10 | MapReduce (Dean & Ghemawat) | 2004 | 分布式计算 | ⭐⭐⭐ | ⬜ 待读 |
| 11 | Dynamo: Amazon's Highly Available Key-value Store | 2007 | 分布式数据库 | ⭐⭐⭐ | ⬜ 待读 |
| 12 | Bigtable (Chang et al.) | 2006 | 分布式存储 | ⭐⭐ | ⬜ 待读 |
| 13 | Paxos Made Simple (Lamport) | 2001 | 共识算法 | ⭐⭐⭐ | ⬜ 待读 |
| 14 | In Search of an Understandable Consensus Algorithm (Raft) | 2014 | 共识算法 | ⭐⭐⭐ | ⬜ 待读 |
...
| 21 | Spanner: Google's Globally Distributed Database | 2012 | 分布式数据库 | ⭐⭐ | ⬜ 待读 |
