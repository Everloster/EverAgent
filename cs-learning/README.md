...
> 创建日期：2026-03-24 | 最后更新：2026-03-26（v2）
...
**论文精读报告：**
- [Turing (1950)](./reports/paper_analyses/01_turing_1950_分析报告.md)
- [Shannon (1948)](./reports/paper_analyses/02_shannon_1948_分析报告.md)
- [Lamport Clocks (1978)](./reports/paper_analyses/05_lamport_clocks_1978_分析报告.md)
- [GFS (2003)](./reports/paper_analyses/09_gfs_2003_分析报告.md)
- [MapReduce (2004)](./reports/paper_analyses/10_mapreduce_2004_分析报告.md)
- [Dynamo (2007)](./reports/paper_analyses/11_dynamo_2007_分析报告.md)
- [Bigtable (2006)](./reports/paper_analyses/12_bigtable_2006_分析报告.md)
- [Paxos (2001)](./reports/paper_analyses/13_paxos_2001_分析报告.md)
- [Raft (2014)](./reports/paper_analyses/13_raft_2014_分析报告.md)
- [Spanner (2012)](./reports/paper_analyses/21_spanner_2012_分析报告.md)
...
| # | 论文 | 年份 | 领域 | 优先级 | 分析报告 |
|---|------|------|------|--------|---------|
| 01 | Computing Machinery and Intelligence (Turing) | 1950 | 计算理论 | ⭐⭐⭐ | ✅ [已完成](./reports/paper_analyses/01_turing_1950_分析报告.md) |
| 02 | A Mathematical Theory of Communication (Shannon) | 1948 | 信息论 | ⭐⭐⭐ | ✅ [已完成](./reports/paper_analyses/02_shannon_1948_分析报告.md) |
| 03 | A Relational Model of Data for Large Shared Data Banks (Codd) | 1970 | 数据库 | ⭐⭐⭐ | ⬜ 待读 |
| 04 | The UNIX Time-Sharing System (Ritchie & Thompson) | 1974 | 操作系统 | ⭐⭐⭐ | ⬜ 待读 |
| 05 | Time, Clocks, and the Ordering of Events (Lamport) | 1978 | 分布式 | ⭐⭐⭐ | ✅ [已完成](./reports/paper_analyses/05_lamport_clocks_1978_分析报告.md) |
...
| 09 | The Google File System (Ghemawat et al.) | 2003 | 分布式存储 | ⭐⭐⭐ | ✅ [已完成](./reports/paper_analyses/09_gfs_2003_分析报告.md) |
| 10 | MapReduce (Dean & Ghemawat) | 2004 | 分布式计算 | ⭐⭐⭐ | ✅ [已完成](./reports/paper_analyses/10_mapreduce_2004_分析报告.md) |
| 11 | Dynamo: Amazon's Highly Available Key-value Store | 2007 | 分布式数据库 | ⭐⭐⭐ | ✅ [已完成](./reports/paper_analyses/11_dynamo_2007_分析报告.md) |
| 12 | Bigtable (Chang et al.) | 2006 | 分布式存储 | ⭐⭐ | ✅ [已完成](./reports/paper_analyses/12_bigtable_2006_分析报告.md) |
| 13 | Paxos Made Simple (Lamport) | 2001 | 共识算法 | ⭐⭐⭐ | ✅ [已完成](./reports/paper_analyses/13_paxos_2001_分析报告.md) |
| 14 | In Search of an Understandable Consensus Algorithm (Raft) | 2014 | 共识算法 | ⭐⭐⭐ | ✅ [已完成](./reports/paper_analyses/13_raft_2014_分析报告.md) |
...
| 21 | Spanner: Google's Globally Distributed Database | 2012 | 分布式数据库 | ⭐⭐ | ✅ [已完成](./reports/paper_analyses/21_spanner_2012_分析报告.md) |
| 22 | Kafka: A Distributed Messaging System for Log Processing | 2011 | 消息队列 | ⭐⭐ | ⬜ 待读 |
...
> 当前已完成论文精读 10 篇，最新库存以 [CONTEXT.md](./CONTEXT.md) 为准。
...
- [x] 精读 Turing (1950) 并生成分析报告
- [x] 精读 Lamport (1978) 并分析分布式时钟模型
- [x] 精读 MapReduce + GFS + Dynamo（分布式三驾马车）
- [x] 深入理解 Paxos / Raft 共识算法差异
- [ ] 阅读 CLRS 第1-10章并做笔记
