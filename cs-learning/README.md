...
| 13 | Paxos Made Simple (Lamport) | 2001 | 共识算法 | ⭐⭐⭐ | ⬜ 待读 |
...
> 当前已完成论文精读 9 篇，最新库存以 [CONTEXT.md](./CONTEXT.md) 为准。
...
- [ ] 精读 Turing (1950) 并生成分析报告
- [ ] 精读 Lamport (1978) 并分析分布式时钟模型
- [ ] 精读 MapReduce + GFS + Dynamo（分布式三驾马车）
- [ ] 深入理解 Paxos / Raft 共识算法差异
- [ ] 阅读 CLRS 第1-10章并做笔记
