...
| 相关报告 | 关联点 |
|---------|--------|
| [InstructGPT 分析](../paper_analyses/04_instructgpt_2022_分析报告.md) | InstructGPT 的 SFT 阶段是 LoRA 最常见的应用场景 |
| [RLHF 深度解析](./RLHF_深度解析.md) | DPO/RLHF 训练时几乎都用 LoRA 减少显存需求 |
| [Tulu 3 分析](../paper_analyses/26_tulu3_2024_后训练分析报告.md) | Tulu 3 的后训练实验全部基于 LoRA 变体 |
